...
// inisialisasi navigator tab bawah (Tab.Navigator) yang memiliki ikon dan label untuk setiap tab "Task", "Completed", dan "About"
const BottomNavigator = () => {
  return (
    ...
    // menentukan komponen layar yang akan ditampilkan 
    >
      <Tab.Screen
        name="Task"
...
// BottomNavigator yang merupakan komponen yang berisi Tab.Navigator.
const App = () => {
  return (
    <NativeBaseProvider>
      <NavigationContainer>
