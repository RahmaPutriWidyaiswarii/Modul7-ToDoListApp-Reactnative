...
const AboutScreen = () => {
    // state yang digunakan untuk mengontrol visibilitas dialog konfirmasi penghapusan data (AlertClearData).
    const [isClearDataOpen, setIsClearDataOpen] = useState(false);
    
    // Fungsi handleClearData
    // AsyncStorage.clear() untuk menghapus semua data yang disimpan pada penyimpanan lokal asynchronous.
    // AlertClearData, Menampilkan AlertDialog NativeBase untuk memberikan konfirmasi sebelum menghapus data, terdapat dua tombol untuk mengonfirmasi atau membatalkan penghapusan data.
    ...
    // Menampilkan AlertClearData yang menyertakan tombol "Clear Data" yang ketika ditekan akan membuka dialog konfirmasi penghapusan data.
    return (
    <Box flex={1}>
        <AlertClearData />
